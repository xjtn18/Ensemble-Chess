...
#All Sounds
s_select = MySound			(pg.mixer.Sound('sounds/screenshot.wav'), 		1, 0.2, 0)
s_select_cm = MySound		(pg.mixer.Sound('sounds/C#_AMBIENT.wav'), 		2, 0.6, -1)
s_move = MySound			(pg.mixer.Sound('sounds/trap kick.wav'), 		3, 0.5, 0)
s_rain = MySound			(pg.mixer.Sound('sounds/rain.wav'), 			4, 0.3, -1)
